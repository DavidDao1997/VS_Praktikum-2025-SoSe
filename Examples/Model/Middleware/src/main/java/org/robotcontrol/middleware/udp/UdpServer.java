...
public class UdpServer {
    ...
    private Map<DatagramSocket, ServerStub_I> services2;
    private Dns dns = new DnsClient();

    public UdpServer() {
        this.services = new HashMap<>();
        this.services2 = new HashMap<>();
    ...
    public void addService(DatagramSocket socket, ServerStub_I service) {
        this.services2.put(socket, service);
    }
    ...
    public void Listen() {
        ...
        for (Map.Entry<DatagramSocket, ServerStub_I> entry: services2.entrySet()) {
