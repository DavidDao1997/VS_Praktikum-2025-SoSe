...
\textcolor{red}{TODO: Zu jdeem use case mind 1}
\section{Szenario I}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\linewidth]{diagrams/Namensauflösung.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\linewidth]{diagrams/Watchdog.png}
	\caption{Watchdog}
	\label{fig:Watchdog}
\end{figure}
