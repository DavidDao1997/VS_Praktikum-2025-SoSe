...
\begin{tabular}{|p{1.5cm}|p{4cm}|p{8.5cm}|}
	...
	\hline
	U8 & Watchdog & Der Watchdog informiert Subscriber ob andere Services verfügbar sind.\\      %Für überwachte Health-Observables werden Watchdogs angelegt. Diese überwachen die Verfügbarkeit der Teilnehmer, wenn Lebenszeichen ausbleiben werden Health-Observer benachrichtigt.  \\
	\hline
