...
\begin{itemize}
    ...
    sodass die Roboterarme sich ohne Einschränkungen bewegen können. % TODO ist eine sicherung eingebaut, dass sich die roboter nicht selbst beschädigen können?
    ...
    % \item \textbf{Betriebssicherheit:} Das System muss sicherstellen, dass Roboterarme zu keinem Zeitpunkt Personen oder Objekte gefährden können.
    \end{itemize}
